# Graph Report - professional-design-system  (2026-07-12)

## Corpus Check
- 415 files · ~819,956 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2582 nodes · 2437 edges · 329 communities (270 shown, 59 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 4 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `30d3d264`
...
2. `Component candidates (105 total, grouped by category)` - 15 edges
3. `expectNoConsoleErrors()` - 15 edges
4. `Phase 0 Research: Micro-Interaction & Utility Primitives` - 13 edges
5. `Tasks: [FEATURE NAME]` - 13 edges
6. `Tasks: Design System Primitive Components` - 13 edges
7. `Data Model: Feedback & Data Display Primitives` - 12 edges
...
## Communities (329 total, 59 thin omitted)
...
Cohesion: 0.11
Nodes (18): applyBlocks, BASE_TOKENS, COVERED_FG_TOKENS, DECORATIVE_ARIA_HIDDEN_TOKENS, failures, htmlFiles, ICON_FILL_TEXT_TOKENS, NON_COLOR_TEXT_SUFFIXES (+10 more)
...
Cohesion: 0.11
Nodes (17): Content Quality, Feature Readiness, Notes, Requirement Completeness, Specification Quality Checklist: Curated Theme Presets, Assumptions, Edge Cases, Feature Specification: Curated Theme Presets (+9 more)

### Community 323 - "Implementation Plan: Curated Theme Presets"
Cohesion: 0.20
Nodes (9): Complexity Tracking, Constitution Check, Documentation (this feature), Implementation Plan: Curated Theme Presets, Project Structure, Scale/Scope Batching Decision (research.md, Scale/Scope section), Source Code (repository root), Summary (+1 more)

### Community 324 - "Research: Curated Theme Presets"
Cohesion: 0.22
Nodes (8): R1. Theme architecture mechanism — CSS custom properties via Tailwind's RGB-tuple technique, confirmed empirically, R2. The AAA/AA contrast re-verification bottleneck — parametrize the existing audit script, don't hand-verify 40 times, R3. Where the 40+ theme names/directions come from — real, fetched inventories, not invented, R4. Gallery/preview mechanism, R5. Persistence mechanism, Research: Curated Theme Presets, Scale/Scope batching decision, Testing strategy
...
## Knowledge Gaps
- **1597 isolated node(s):** `graphify`, `Markup contract`, `Required attributes`, `Token allowlist used`, `Acceptance mapping` (+1592 more)
...
- **What connects `graphify`, `Markup contract`, `Required attributes` to the rest of the system?**
