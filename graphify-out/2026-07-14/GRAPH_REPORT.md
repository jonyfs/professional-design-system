...
## Corpus Check
- 743 files · ~1,214,525 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4516 nodes · 5041 edges · 487 communities (419 shown, 68 thin omitted)
...
7. `Component Catalog & Tailwind UI Patterns` - 16 edges
...
## Communities (487 total, 68 thin omitted)
...
Cohesion: 0.05
Nodes (40): Component gallery, Governance, Professional Design System, Project structure, React package, Requirements, Scripts, Setup (+32 more)
...
Cohesion: 0.02
Nodes (109): Accordion(), AccordionItemData, AccordionProps, ActionIcon, ActionIconProps, Anchor(), AnchorProps, AvatarGroup() (+101 more)
...
## Knowledge Gaps
- **2608 isolated node(s):** `countries`, `actions`, `projectActions`, `teamMembers`, `notifications` (+2603 more)
