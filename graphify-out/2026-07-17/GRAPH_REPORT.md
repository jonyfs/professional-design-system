...
## Summary
- 4752 nodes · 5010 edges · 562 communities (455 shown, 107 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 12 edges (avg confidence: 0.62)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `575c1433`
...
1. `expectNoA11yViolations()` - 94 edges
...
## Communities (562 total, 107 thin omitted)
...
## Knowledge Gaps
- **2811 isolated node(s):** `Level`, `LEVEL_LABEL`, `providerBrand`, `ThemeTokens`, `ThemeDefinition` (+2806 more)
...
- **What connects `Level`, `LEVEL_LABEL`, `providerBrand` to the rest of the system?**
