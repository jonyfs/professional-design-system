# Graph Report - professional-design-system  (2026-07-09)

## Corpus Check
- 203 files · ~389,538 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1184 nodes · 1129 edges · 152 communities (135 shown, 17 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 4 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `afd4c21b`
...
7. `Tasks: Navigation & Disclosure Primitives` - 11 edges
8. `scripts` - 11 edges
9. `speckit-specify Skill` - 11 edges
10. `Tasks: Application Shell Primitives` - 10 edges
...
Cohesion: 0.06
Nodes (29): Component gallery, Governance, Professional Design System, Project structure, React package, Requirements, Scripts, Setup (+21 more)
...
Cohesion: 0.23
Nodes (9): Button, ButtonProps, Modal(), ModalProps, SlideOver(), SlideOverProps, Toast(), ToastProps (+1 more)
...
## Knowledge Gaps
- **734 isolated node(s):** `Format: `[ID] [P?] [Story] Description``, `Path Conventions`, `Tests for User Story 1`, `Implementation for User Story 1`, `Tests for User Story 2` (+729 more)
