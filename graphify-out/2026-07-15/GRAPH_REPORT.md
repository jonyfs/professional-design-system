...
## Corpus Check
- 769 files · ~1,229,850 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4671 nodes · 5198 edges · 500 communities (436 shown, 64 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 12 edges (avg confidence: 0.62)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3889cf59`
...
6. `useSeriesVisibility()` - 17 edges
7. `Component Catalog & Tailwind UI Patterns` - 17 edges
...
- `DataTableProps` --references--> `CrudConfig`  [EXTRACTED]
  packages/react/src/DataTable/DataTable.tsx → shared/data-table/types.ts
- `DataTableProps` --references--> `DataTableRow`  [EXTRACTED]
  packages/react/src/DataTable/DataTable.tsx → shared/data-table/types.ts
- `DataTable()` --calls--> `applyFilter()`  [EXTRACTED]
  packages/react/src/DataTable/DataTable.tsx → shared/data-table/filtering.ts
...
## Communities (500 total, 64 thin omitted)
...
Cohesion: 0.05
Nodes (41): Component gallery, Governance, Professional Design System, Project structure, React package, Requirements, Scripts, Setup (+33 more)
...
Cohesion: 0.02
Nodes (117): Accordion(), AccordionItemData, AccordionProps, ActionIcon, ActionIconProps, Affix(), AffixProps, Alert() (+109 more)
...
Cohesion: 0.40
Nodes (6): borderRadius, colors, fontFamily, REQUIRED_THEME_PROPERTIES, ThemeDefinition, ThemeTokens
...
Cohesion: 0.11
Nodes (17): Content Quality, Feature Readiness, Notes, Requirement Completeness, Specification Quality Checklist: Configurable Social Login Buttons, Assumptions, Edge Cases, Feature Specification: Configurable Social Login Buttons (+9 more)
...
## Knowledge Gaps
- **2693 isolated node(s):** `countries`, `actions`, `projectActions`, `teamMembers`, `notifications` (+2688 more)
...
- **Why does `DataTable()` connect `Modal.tsx` to `index.ts`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
- **Why does `Combobox()` connect `Radio.tsx` to `index.ts`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
