# Graph Report - professional-design-system  (2026-07-13)

## Corpus Check
- 557 files · ~1,161,698 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3424 nodes · 3797 edges · 364 communities (299 shown, 65 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 9 edges (avg confidence: 0.66)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `743c67b0`
...
1. `expectNoA11yViolations()` - 86 edges
2. `stripNonDigits()` - 33 edges
3. `expectNoConsoleErrors()` - 21 edges
4. `Component candidates (105 total, grouped by category)` - 15 edges
5. `DataTable()` - 14 edges
6. `useChartColors()` - 14 edges
7. `usePrefersReducedMotion()` - 14 edges
8. `ValidationResult` - 14 edges
9. `LocalizedInputFieldProps` - 13 edges
...
## Communities (364 total, 65 thin omitted)
...
Cohesion: 0.06
Nodes (32): Component gallery, Governance, Professional Design System, Project structure, React package, Requirements, Scripts, Setup (+24 more)
...
Cohesion: 0.06
Nodes (44): acceptedGaps, applyBlocks, buildTokenMap(), compositeOver(), COVERED_FG_TOKENS, DECORATIVE_ARIA_HIDDEN_TOKENS, failures, htmlFiles (+36 more)
...
Cohesion: 0.17
Nodes (32): AreaChart(), AreaChartProps, BarChart(), BarChartProps, CHART_COLOR_TOKENS, ChartDataTable(), ChartDataTableProps, ChartEmptyState() (+24 more)
...
Cohesion: 0.08
Nodes (46): CommandPalette(), CommandPaletteProps, highlight(), DataTable(), DataTableProps, sortIcon(), DataTableFieldDefinition, DataTableForm() (+38 more)
...
Cohesion: 0.05
Nodes (48): Accordion(), AccordionItemData, AccordionProps, Alert(), AlertProps, VARIANT_ICON_CLASSES, VARIANT_ICON_PATHS, Avatar() (+40 more)
...
### Community 298 - "pin-input.spec.ts"
Cohesion: 0.33
...
## Knowledge Gaps
- **2020 isolated node(s):** `countries`, `actions`, `projectActions`, `teamMembers`, `notifications` (+2015 more)
...
- **Why does `ComboboxProps` connect `Radio.tsx` to `index.ts`?**
  _High betweenness centrality (0.000) - this node is a cross-community bridge._
- **Why does `expectNoA11yViolations()` connect `a11y-helper.ts` to `feature-015-csp-sweep.spec.ts`, `button.spec.ts`, `react-modal.spec.ts`, `context-menu.spec.ts`, `react-select.spec.ts`, `select.spec.ts`?**
  _High betweenness centrality (0.000) - this node is a cross-community bridge._
