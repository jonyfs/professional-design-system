...
- **The stylesheet is a separate import.** `import "professional-design-system/styles.css"` must run once, anywhere in your app's entry point. It is fully self-contained pre-compiled CSS — no Tailwind installation is required in your project, and none of its classes need a build step of yours to resolve.
