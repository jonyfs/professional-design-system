...
Added sections:
  ...
  - Theming & Multi-Palette Architecture → new paragraph documenting a
    ...
    downstream consumer of `professional-design-system` that
...
`professional-design-system` who didn't separately author an
...
the published `professional-design-system` package. This
